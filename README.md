...
4- Create a MySQL database named **\`Dressify_ecommerce\`**, then import the **[Dressify_ecommerce database SQL Dump File](<Database - Dressify_ecommerce/Dressify_ecommerce database - SQL Dump File - phpMyAdmin Export.sql>)** into your **\`Dressify_ecommerce\`** database.
