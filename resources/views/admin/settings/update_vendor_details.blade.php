                                ...
                                <form class="forms-sample" action="{{ url('admin/update-vendor-details/business') }}" method="post" enctype="multipart/form-data"> @csrf <!-- Using the enctype="multipart/form-data" to allow uploading files (images) -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="address_proof" id="address_proof">
                                            ...
                                            <option value="FBR id"     @if(isset($vendorDetails['address_proof']) && $vendorDetails['address_proof'] == 'FBR id')     selected @endif>FBR Id</option>
                                            ...
                                            <option value="ID card"     @if(isset($vendorDetails['address_proof']) && $vendorDetails['address_proof'] == 'ID card')     selected @endif>ID Card</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
